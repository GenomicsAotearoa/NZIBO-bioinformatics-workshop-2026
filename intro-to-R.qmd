...
::: {.column width="20%"}
![](theme-images/Rlogo-colour.jpeg)
:::
...
At more than 30 years old, R is fairly mature and [growing in popularity](https://www.tiobe.com/tiobe-index/r/). However, programming isn't a popularity contest. Here are key advantages of analysing data in R:
...
First, go to your desktop and create a folder called `bioinformatics-day`. This is where we will save all of the files we create during this workshop. You can also create an RStudio project for this folder if you like (see above).
...
You can set your home directory using the `setwd()` command. Enter this command in your
...
setwd() # This sets the working directory
```
...
Linux. Then enter the path to the folder you want to set as your working directory. For example, if you have a folder on your desktop called `bioinformatics-day`, you would enter the following command:

(Note: replace `username` with your actual username on your computer!)

```{r}
#| eval: false

# This sets the working directory 
setwd("/Users/username/Desktop/bioinformatics-day")
```
...
We will need a few different packages today, let's start with installing those:
